...
Ecrivez le script entreprise.js exploitant cette Classe.
...
Les deux objets « pierre » et  « paul » sont déjà instanciés. Affichez par de simples

console.log() leurs nom, prenom, branche et salaire.

 

Ajoutez à la classe Employe, l’attribut privé « responsable », il fera référence à un autre employé.
